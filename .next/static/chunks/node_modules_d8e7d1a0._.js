...
var serializer_default = {
  ...
  */ decode (rawPayload, callback) {
    ...
    assertFieldSize (size, name) {
        if (size > 255) {
            throw new Error("unable to convert ".concat(name, " to binary: must be less than or equal to 255 bytes, but is ").concat(size, " bytes"));
        }
    },
    /**
  * @private
...
var StorageBucketApi = class extends BaseApiClient {
	...
	*/ async purgeBucketCache(id, options, parameters) {
        ...
        return _this7.handleOperation(async ()=>{
            ...
            if (options === null || options === void 0 ? void 0 : options.transformations) query.set("transformations", "true");
            const queryString = query.toString();
            return await remove(_this7.fetch, "".concat(_this7.url, "/cdn/").concat(encodeStoragePath(id)).concat(queryString ? "?".concat(queryString) : ""), {}, {
                headers: _this7.headers
            }, parameters);
        });
    }
...
const fetchWithAuth = (supabaseKey, supabaseUrl, getAccessToken, customFetch, tracePropagationOptions, options)=>{
    ...
    return async (input, init)=>{
        ...
        if (!headers.has("Authorization")) {
            ...
            if (bearer) headers.set("Authorization", "Bearer ".concat(bearer));
        }
        if (traceTargets) {
...
//# sourceMappingURL=node_modules_d8e7d1a0._.js.map